...
class TipoCargoDataGrid extends TStandardListWAM
{
    protected $form;
    protected $datagrid;
    ...
    public function __construct()
    {
        ...
        /** @var TQuickForm $this */
        $this->form = new \Adianti\Widget\Wrapper\TQuickForm('TipoCargoDataGrid');
        ...
        $this->form->setData(\Adianti\Registry\TSession::getValue('tipocargo_filtro'));

        $this->datagrid = new \Adianti\Widget\Wrapper\TQuickGrid;
        $this->datagrid->style = 'width: 100%';
        $this->datagrid->setHeight(230);

        $this->datagrid->addQuickColumn('ID','idtipocargo','right',40,new \Adianti\Control\TAction(array($this,'onReload')),array('order','idtipocargo'));
        ...
        $this->datagrid->addQuickAction('Editar',new \Adianti\Widget\Datagrid\TDataGridAction(array('TipoCargoFormView','onEdit')),'idtipocargo','ico_edit.png');
        $this->datagrid->addQuickAction('Excluir',new \Adianti\Widget\Datagrid\TDataGridAction(array($this,'onDelete')),'idtipocargo','ico_delete.png');
        ...
        $vbox= new TVBox;
        $vbox->add(new \Adianti\Widget\Util\TXMLBreadCrumb('menu.xml','TipoCargoFormView'));
        $vbox->add($this->form);
