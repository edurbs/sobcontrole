 ...
 */
class TStandardSeek2 extends TWindow
{
    ...
    public function __construct()
    {
        ...
        $display2 = new TDataGridColumn('display_field2', AdiantiCoreTranslator::translate('Field'), 'left');
        
        // add the columns to the datagrid
        $this->datagrid->addColumn($id);
        $this->datagrid->addColumn($display);
        $this->datagrid->addColumn($display2);
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            {
                $display_field = TSession::getValue('standard_seek_display_field');
                $display_field2 = TSession::getValue('standard_seek_display_field2');
                foreach ($objects as $object)
                {
                    ...
                    // @todo testar
                    $item-> display_field2 = $object->$display_field2;
    ...
    public function onSetup($param=NULL)
    {
        ...
        TSession::setValue('standard_seek_display_field2', $param['display_field2']);
